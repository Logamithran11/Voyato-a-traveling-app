      ...
      <Card className="shadow-lg">
        ...
        <CardContent className="space-y-8 pt-6">
          ...
          <div className="text-center">
            ...
            <p className="text-muted-foreground">Myths, legends, history narrated live.</p>
          </div>
          ...
          <div>
            ...
            <div className="flex items-center justify-center space-x-2 md:space-x-4 text-muted-foreground">
                ...
                <div className="flex flex-col items-center text-center">
                    ...
                    <span className="font-semibold">2. Auto-Play Stories</span>
                </div>
                 <div className="flex-1 border-t-2 border-dashed mx-2"></div>
                <div className="flex flex-col items-center text-center">
                    <Save className="h-8 w-8 mb-2"/>
                    <span className="font-semibold">3. Save Favorites</span>
                </div>
            </div>
          </div>
