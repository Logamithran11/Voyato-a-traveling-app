...
import { ArrowLeft, Users, FileText, Camera, Group, LogIn, MessageSquare } from 'lucide-react';
import Link from 'next/link';
import { Separator } from '@/components/ui/separator';

export default function CommunityHubPage() {
    const highlights = [
        { text: 'Share itineraries', icon: FileText },
        { text: 'Reviews & photos', icon: Camera },
        { text: 'Group trips', icon: Group },
    ];
      ...
      <Card className="shadow-lg">
        ...
        <CardContent className="space-y-8 pt-6">
          ...
          <div className="text-center">
            ...
            <p className="text-muted-foreground">Connect with fellow explorers.</p>
          </div>
          ...
          <div>
            ...
            <div className="flex items-center justify-center space-x-2 md:space-x-4 text-muted-foreground">
                <div className="flex flex-col items-center text-center">
                    ...
                    <span className="font-semibold">1. Join Hub</span>
                </div>
                 <div className="flex-1 border-t-2 border-dashed mx-2"></div>
                <div className="flex flex-col items-center text-center">
                    <MessageSquare className="h-8 w-8 mb-2"/>
                    <span className="font-semibold">2. Post</span>
                </div>
                 <div className="flex-1 border-t-2 border-dashed mx-2"></div>
                <div className="flex flex-col items-center text-center">
                    <Users className="h-8 w-8 mb-2"/>
                    <span className="font-semibold">3. Connect</span>
                </div>
            </div>
          </div>
        ...
        <CardFooter className="justify-center pt-6">
            <Button size="lg" className="w-full max-w-xs" asChild>
                <Link href="/community-hub">Join Community</Link>
            </Button>
        </CardFooter>
      </Card>
    </div>
